...
Denetimler:
  ...
  * dil klasörleri ZaLocale.TAGS ile birebir mi (uygulamada olan dil mağazada da
...
def app_languages():
    ...
    if not block:
        errors.append("ZaLocale.TAGS okunamadı")
        return []
...
for lang in langs:
    if lang not in app:
        errors.append(f"store/play/{lang}/ var, ZaLocale.TAGS'te {lang} yok")
