...
add("tr", "Türkçe", "Gizlilik politikası",
    ...
    [("Toplanan veriler",
      "Hiçbiri. ZA Games ad, e-posta, konum, cihaz kimliği, kullanım istatistiği, çökme raporu ya da "
     ...
     ("İzinler ve ağ",
      ...
      "ZA Games hiçbir sunucuya bağlanmaz; günlük bulmacalar cihaz tarihinden çevrimdışı üretilir."),
     ("Cihazda kalanlar",
      "Rekorlar, seriler, günlük bulmaca ilerlemesi ve ayarlar uygulamanın özel alanında saklanır; başka "
      ...
      "sizin Google hesabınıza aittir ve ZA Games ona erişemez."),
     ("Sonuç paylaşımı",
      ...
      "için verilir; ZA Games'in kendisi hiçbir şey göndermez ve kimin ne paylaştığını bilmez."),
...
add("en", "English", "Privacy policy",
    ...
    [("Data collected",
     ...
     ("Permissions and network",
      "The app manifest declares no <code>uses-permission</code> at all, not even INTERNET. ZA Games "
      "connects to no server; daily puzzles are generated offline from the device date."),
     ("What stays on your device",
      "High scores, streaks, daily-puzzle progress and settings live in the app's private storage, where "
      ...
      "your Google account; ZA Games cannot access it."),
     ("Sharing results",
      "The &quot;Share&quot; button renders a result image and a short text, then opens the Android "
      "share sheet. The image is handed read-only to the app you choose; ZA Games itself sends nothing "
...
add("de", "Deutsch", "Datenschutzerklärung",
    ...
    [("Erhobene Daten",
     ...
     ("Berechtigungen und Netz",
      ...
      "ZA Games verbindet sich mit keinem Server; die täglichen Rätsel entstehen offline aus dem "
      "Gerätedatum."),
     ("Was auf dem Gerät bleibt",
      "Rekorde, Serien, der Fortschritt im Tagesrätsel und die Einstellungen liegen im privaten Speicher "
      ...
      "Standardsicherung landen, die deinem Google-Konto gehört; ZA Games hat darauf keinen Zugriff."),
     ("Ergebnisse teilen",
      "Die Schaltfläche &quot;Teilen&quot; erzeugt ein Ergebnisbild und einen kurzen Text und öffnet dann "
      "das Teilen-Menü von Android. Das Bild geht nur lesend an die App, die du auswählst; ZA Games "
...
add("fr", "Français", "Politique de confidentialité",
    ...
    [("Données collectées",
     ...
     ("Autorisations et réseau",
      ...
      "ZA Games ne se connecte à aucun serveur ; les énigmes du jour sont générées hors ligne à partir "
      "de la date de l'appareil."),
     ("Ce qui reste sur votre appareil",
      "Records, séries, progression de l'énigme du jour et réglages vivent dans le stockage privé de "
      ...
      "sauvegarde standard qui appartient à votre compte Google ; ZA Games n'y a pas accès."),
     ("Partage des résultats",
      ...
      "choisissez ; ZA Games n'envoie rien et ignore ce qui a été partagé."),
...
add("nl", "Nederlands", "Privacybeleid",
    ...
    [("Verzamelde gegevens",
     ...
     ("Rechten en netwerk",
      "Het app-manifest bevat geen enkele <code>uses-permission</code>, zelfs INTERNET niet. ZA Games "
     ...
     ("Wat op je toestel blijft",
      "Records, reeksen, de voortgang van de dagpuzzel en de instellingen staan in de privéopslag van de "
      ...
      "die bij je Google-account hoort; ZA Games kan daar niet bij."),
     ("Resultaten delen",
      "De knop &quot;Delen&quot; maakt een resultaatafbeelding en een korte tekst en opent daarna het "
      "deelvenster van Android. De afbeelding gaat alleen-lezen naar de app die jij kiest; ZA Games zelf "
...
add("es", "Español", "Política de privacidad",
    ...
    [("Datos recopilados",
     ...
     ("Permisos y red",
      ...
      "ZA Games no se conecta a ningún servidor; los puzles diarios se generan sin conexión a partir de "
      "la fecha del dispositivo."),
     ("Lo que se queda en tu dispositivo",
      "Récords, rachas, el progreso del puzle diario y los ajustes viven en el almacenamiento privado de "
      ...
      "estándar que pertenece a tu cuenta de Google; ZA Games no puede acceder a ella."),
     ("Compartir resultados",
      ...
      "ZA Games no envía nada y no sabe qué se compartió."),
...
add("pt", "Português", "Política de privacidade",
    ...
    [("Dados coletados",
     ...
     ("Permissões e rede",
      "O manifesto do app não declara uma única <code>uses-permission</code>, nem INTERNET. O ZA Games "
      "não se conecta a nenhum servidor; os desafios diários são gerados offline a partir da data do "
      "aparelho."),
     ("O que fica no seu aparelho",
      "Recordes, sequências, o progresso do desafio diário e as configurações ficam no armazenamento "
      ...
      "à sua conta do Google; o ZA Games não consegue acessá-lo."),
     ("Compartilhar resultados",
      ...
      "ZA Games não envia nada e não sabe o que foi compartilhado."),
...
add("it", "Italiano", "Informativa sulla privacy",
    ...
    [("Dati raccolti",
     ...
     ("Permessi e rete",
      ...
      "ZA Games non si collega ad alcun server; i rompicapi del giorno nascono offline dalla data del "
      "dispositivo."),
     ("Ciò che resta sul dispositivo",
      "Record, serie, avanzamento del rompicapo del giorno e impostazioni stanno nella memoria privata "
      ...
      "appartiene al tuo account Google; ZA Games non può accedervi."),
     ("Condividere i risultati",
      ...
      "ZA Games non invia nulla e non sa cosa è stato condiviso."),
...
add("da", "Dansk", "Privatlivspolitik",
    ...
    [("Indsamlede data",
     ...
     ("Tilladelser og netværk",
      ...
      "ZA Games forbinder til ingen server; de daglige opgaver dannes offline ud fra enhedens dato."),
     ("Det, der bliver på enheden",
      "Rekorder, rækker, fremdrift i dagens opgave og indstillinger ligger i appens private lager, hvor "
      ...
      "der hører til din Google-konto; ZA Games har ikke adgang til den."),
     ("Deling af resultater",
      "Knappen &quot;Del&quot; laver et resultatbillede og en kort tekst og åbner derefter Androids "
      "deleark. Billedet gives skrivebeskyttet til den app, du vælger; ZA Games sender selv intet og ved "
...
add("sv", "Svenska", "Integritetspolicy",
    ...
    [("Insamlade uppgifter",
     ...
     ("Behörigheter och nätverk",
      "Appens manifest deklarerar inte en enda <code>uses-permission</code>, inte ens INTERNET. ZA Games "
      "ansluter till ingen server; dagens pussel skapas offline utifrån enhetens datum."),
     ("Det som stannar på din enhet",
      "Rekord, serier, framsteg i dagens pussel och inställningar ligger i appens privata lagring, dit "
      ...
      "ZA Games kommer inte åt den."),
     ("Dela resultat",
      "Knappen &quot;Dela&quot; skapar en resultatbild och en kort text och öppnar sedan Androids "
      "delningsruta. Bilden lämnas skrivskyddad till appen du väljer; ZA Games skickar ingenting själv "
...
add("nb", "Norsk bokmål", "Personvernerklæring",
    ...
    [("Innsamlede data",
     ...
     ("Tillatelser og nett",
      ...
      "ZA Games kobler seg til ingen server; dagens oppgaver lages offline ut fra datoen på enheten."),
     ("Det som blir igjen på enheten",
      "Rekorder, rekker, fremdrift i dagens oppgave og innstillinger ligger i appens private lager, der "
      ...
      "Google-kontoen din; ZA Games har ikke tilgang til den."),
     ("Deling av resultater",
      "Knappen &quot;Del&quot; lager et resultatbilde og en kort tekst, og åpner så delingsvinduet i "
      "Android. Bildet gis skrivebeskyttet til appen du velger; ZA Games sender ingenting selv og vet "
...
add("fi", "Suomi", "Tietosuojakäytäntö",
    ...
    [("Kerätyt tiedot",
     ...
     ("Käyttöoikeudet ja verkko",
      ...
      "ZA Games ei ota yhteyttä yhteenkään palvelimeen; päivän pulmat syntyvät offline laitteen "
      "päivämäärästä."),
     ("Mitä laitteeseen jää",
      "Ennätykset, putket, päivän pulman edistyminen ja asetukset ovat sovelluksen omassa "
      ...
      "vakiovarmuuskopioon, joka kuuluu Google-tilillesi; ZA Games ei pääse siihen käsiksi."),
     ("Tulosten jakaminen",
      "&quot;Jaa&quot;-painike luo tuloskuvan ja lyhyen tekstin ja avaa sitten Androidin jakoikkunan. "
      "Kuva annetaan vain luettavaksi valitsemallesi sovellukselle; ZA Games ei lähetä itse mitään eikä "
      "tiedä, mitä jaettiin."),
...
add("ru", "Русский", "Политика конфиденциальности",
    ...
    [("Какие данные собираются",
      ...
      "сторонних SDK."),
     ("Разрешения и сеть",
      "В манифесте приложения нет ни одной строки <code>uses-permission</code>, даже INTERNET. ZA Games "
      "не подключается ни к одному серверу; ежедневные задачи создаются офлайн из даты устройства."),
     ("Что остаётся на устройстве",
      "Рекорды, серии, прогресс ежедневной задачи и настройки лежат в личном хранилище приложения, куда "
      ...
      "принадлежащую вашему аккаунту Google; ZA Games не имеет к ней доступа."),
     ("Обмен результатами",
      ...
      "сам ZA Games ничего не отправляет и не знает, чем поделились."),
...
add("ar", "العربية", "سياسة الخصوصية",
    ...
    [("البيانات المجموعة",
     ...
     ("الأذونات والشبكة",
      ...
      "ZA Games بأي خادم؛ تُولَّد ألغاز اليوم دون اتصال من تاريخ الجهاز."),
     ("ما يبقى على جهازك",
      "الأرقام القياسية والسلاسل وتقدّم لغز اليوم والإعدادات تعيش في التخزين الخاص بالتطبيق حيث لا يصل "
      "إليها تطبيق آخر. تختفي عند إزالة التطبيق أو مسح بياناته. وإذا كان النسخ الاحتياطي في أندرويد "
      "مفعّلًا فقد تُدرج الإعدادات في النسخة القياسية التي تخصّ حسابك في Google؛ ولا يستطيع ZA Games "
      "الوصول إليها."),
     ("مشاركة النتائج",
      "زر &quot;مشاركة&quot; يرسم صورة للنتيجة ونصًّا قصيرًا ثم يفتح لوحة المشاركة في أندرويد. تُسلَّم "
      "الصورة للقراءة فقط إلى التطبيق الذي تختاره؛ ولا يرسل ZA Games نفسه شيئًا ولا يعرف ما جرت مشاركته."),
...
ICON = ("data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Crect "
        "width='32' height='32' rx='7' fill='%230B0F1A'/%3E%3Cg fill='%234DE1FF'%3E%3Crect x='7' y='7' "
        "width='4' height='4' rx='1'/%3E%3Crect x='12' y='7' width='4' height='4' rx='1'/%3E%3Crect "
        "x='17' y='7' width='4' height='4' rx='1'/%3E%3Crect x='22' y='7' width='4' height='4' "
        "rx='1'/%3E%3Crect x='17' y='12' width='4' height='4' rx='1'/%3E%3Crect x='12' y='16' width='4' "
        "height='4' rx='1'/%3E%3Crect x='7' y='21' width='4' height='4' rx='1'/%3E%3Crect x='12' y='21' "
        "width='4' height='4' rx='1'/%3E%3Crect x='17' y='21' width='4' height='4' rx='1'/%3E%3Crect "
        "x='22' y='21' width='4' height='4' rx='1'/%3E%3C/g%3E%3C/svg%3E")
...
def za_tags():
    """ZaLocale.TAGS: uygulamanın dilleri, kaynak sırasıyla."""
...
<title>ZA Games · Gizlilik politikası · Privacy policy</title>
<meta name="description" content="ZA Games gizlilik politikası, 14 dilde: uygulama hiçbir veri toplamaz, hiçbir izin istemez, ağa bağlanmaz.">
...
def main():
    ...
    if extra:
        sys.exit(f"ZaLocale.TAGS içinde olmayan dil: {', '.join(extra)}")
