...
// Tuşe oyun motoru: saf Kotlin/JVM, Android'e bağımlı değil.
// Sabit adımlı (60 Hz) simülasyon; tohumdan deterministik şerit dizisi; ezgiler ve nota sentezi.
plugins {
...
// Denge ölçümü: ./gradlew :games:tuse:probe  (bkz. docs/oyun-testi.md)
