...
// Dalgıç oyun motoru: saf Kotlin/JVM, Android'e bağımlı değil.
// Sabit adımlı (60 Hz) simülasyon; tohumdan deterministik şerit üretimi ve akıntılar.
plugins {
...
// Denge ölçümü: ./gradlew :games:dalgic:probe  (bkz. docs/oyun-testi.md)
