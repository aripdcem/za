...
// Geçit oyun motoru: saf Kotlin/JVM, Android'e bağımlı değil.
// Sabit adımlı (60 Hz) simülasyon; tohumdan deterministik şerit üretimi.
plugins {
...
// Denge ölçümü: ./gradlew :games:gecit:probe  (bkz. docs/oyun-testi.md)
