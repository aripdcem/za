...
// Sincap oyun motoru: saf Kotlin/JVM, Android'e bağımlı değil.
// Sabit adımlı (60 Hz) simülasyon; tohumdan deterministik dal üretimi, her konumdan güvenli kaçış garantili.
plugins {
...
// Denge ölçümü: ./gradlew :games:sincap:probe  (bkz. docs/oyun-testi.md)
