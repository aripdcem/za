...
// Uçurtma oyun motoru: saf Kotlin/JVM, Android'e bağımlı değil.
// Sabit adımlı (60 Hz) simülasyon; tohumdan deterministik engel üretimi.
plugins {
...
// Denge ölçümü: ./gradlew :games:ucurtma:probe  (bkz. docs/oyun-testi.md)
