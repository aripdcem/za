...
// Kuyu oyun motoru: saf Kotlin/JVM, Android'e bağımlı değil.
// Sabit adımlı (60 Hz) simülasyon; tohumdan deterministik kuyu üretimi.
plugins {
...
// Denge ölçümü: ./gradlew :games:kuyu:probe  (bkz. docs/oyun-testi.md)
