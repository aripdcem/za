...
// Çekirge oyun motoru: saf Kotlin/JVM, Android'e bağımlı değil.
// Sabit adımlı (60 Hz) simülasyon; tohumdan deterministik sürü davranışı (tükürük ve kraliçe zamanları).
plugins {
...
// Denge ölçümü: ./gradlew :games:cekirge:probe  (bkz. docs/oyun-testi.md)
