...
// Bostan oyun motoru: saf Kotlin/JVM, Android'e bağımlı değil.
// Sabit adımlı (60 Hz) simülasyon; tohumdan deterministik dalga üretimi, uzman politikasıyla doğrulanır.
plugins {
...
// Denge ölçümü: ./gradlew :games:bostan:probe  (bkz. docs/oyun-testi.md)
