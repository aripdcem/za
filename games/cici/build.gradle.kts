...
// Cici oyun motoru: saf Kotlin/JVM, Android'e bağımlı değil.
// Sabit adımlı (60 Hz) simülasyon; tohumdan deterministik ikram, kedi ve top akışı.
plugins {
...
// Denge ölçümü: ./gradlew :games:cici:probe  (bkz. docs/oyun-testi.md)
